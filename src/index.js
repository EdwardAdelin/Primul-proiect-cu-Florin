...
function onUploadClick2(){
const inputElement2 = document.getElementById('complicatedText');
const textContent2 = inputElement2.value;
console.log('input text: ' + textContent2)
const outputElement2 = document.getElementById('output');
outputElement2.textContent2 = textContent+textContent2;
}
